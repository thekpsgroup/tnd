  ...
  return (
    <div className="container mx-auto px-4 py-12 sm:py-16">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Project Management Team - Names Only */}
        <div className="text-center mb-12">
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
          <div className="flex flex-col items-center text-center">
            <h3 className="text-xl font-semibold mb-1">Cody Moore</h3>
            <p className="text-primary mb-2">Project Manager</p>
            <p className="mt-2 text-muted-foreground">
          ...
          <div className="flex flex-col items-center text-center">
            <h3 className="text-xl font-semibold mb-1">Jerry Black</h3>
            <p className="text-primary mb-2">Project Manager</p>
            <p className="mt-2 text-muted-foreground">
